...
public class ContactUtils {
   ...
   */
    private static ContactDTO generateRandomContactDTO(long currentSystemTime)
    {
     ...
     * */
    private static void insertListData(ContentResolver contentResolver, Uri contentUri, long rawContactId, String mimeType, String dataTypeColumnName, String dataValueColumnName, List<DataDTO> dataList)
    {
        if(dataList!=null) {
